...
[首页](../docs/README.zh-CN.md) | [English](match-015-irn-nzl.md) | [日报](../reports/daily/2026-06-13.zh-CN.md)
...
- 官方赛程：第 015 场是G 组 伊朗 vs 新西兰，场地为 Los Angeles Stadium。
- 开球时间：2026-06-16T01:00:00Z；按本次自动化实际运行时间，处于未来 72 小时窗口内。
- FIFA 2026-06-11 排名页显示伊朗第 20、新西兰第 85。
...
| 维度 | 快照状态 | 对信心的影响 |
| --- | --- | --- |
| 战术 | 已根据小组预览和球队资料检查风格对位、压迫、转换和定位球。 | 混合 |
| 球员 | 已检查排名、名单状态和关键球员背景。 | 支持预测倾向 |
| 伤病 / 停赛 | 仓库尚未存入官方比赛日医疗公告。 | 数据缺口降低信心 |
| 赛程 / 休息 / 旅行 | 已核验开球、场地、中立场旅行和当地时间。 | 混合 |
| 历史 | 历史只作低权重参考，因为名单和教练会变化。 | 低权重 |
| 舆情 | 已检查媒体叙事和球迷预期，只作背景而非证据。 | 混合 |
| 天气 / 场馆条件 | 已检查城市和场馆背景；比赛日天气尚未存入。 | 数据缺口降低信心 |
| 心理 | 已考虑首战谨慎、热门压力和下风方动力。 | 混合 |
| 赔率变化 | 在可用范围内检查公开预览价格 / 背景；仓库未存变化轨迹。 | 数据缺口 |
| 专家观点 | 已查看可靠小组预览，分歧体现在信心等级中。 | 支持中等或更低信心 |

## 预测逻辑

1. 概率分布体现排名和阵容质量信号，同时保留首轮小组赛的平局风险。
2. 比赛脚本倾向伊朗胜，2-0，但场外压力与新西兰定位球是最可能改变基础判断的路径。
3. 由于首发、天气和赔率变化快照尚未完全核验，信心不会上调到高。

## 风险因素

- 场外压力与新西兰定位球
- 最终首发和比赛日医疗公告尚未存入仓库。
- 若早段出现定位球进球，比赛状态会明显变化。

## 平台发布文案

### 抖音

世界杯 G 组 预测：伊朗 vs 新西兰。我倾向伊朗胜，2-0，关键风险是场外压力与新西兰定位球。
仅为足球赛事预测，不构成任何投资建议。

### 小红书

伊朗 vs 新西兰 预测：伊朗胜，2-0。判断基于官方赛程、FIFA 排名、名单状态和当前预览背景。
仅为足球赛事预测，不构成任何投资建议。

### 微博

G 组 预测：伊朗胜，2-0。概率：IRN 62%，平局 24%，NZL 14%。信心：中等。
仅为足球赛事预测，不构成任何投资建议。#世界杯# #WorldCup2026#

### 微信

伊朗 vs 新西兰 的预测是伊朗胜，2-0。当前判断来自官方赛程、FIFA 排名页、名单确认和可靠预览。This is a football match prediction only and does not constitute investment advice. 仅为足球赛事预测，不构成任何投资建议。
