...
| --- | --- | ---: | --- |
| Primary | 2-1 | 13% | France edge a balanced game while Senegal still score through transition or set pieces. |
| Conservative / draw path | 1-1 | 11% | Senegal keep the match compact and the unresolved lineup/weather gaps preserve draw risk. |
| Upside / alternate | 1-0 | 9% | France control possession but the match stays low scoring if Senegal defend deep. |
