...
# 第 070 场：刚果（金） vs 乌兹别克斯坦

[仪表盘](../docs/README.zh-CN.md) | [English](match-070-cod-uzb.md) | [日报](../reports/daily/2026-06-28.zh-CN.md)
...
| 情景 | 比分 | 概率 | 判断 |
| --- | --- | ---: | --- |
| 主情景 | 2-1 | 11% | 刚果（金）身体优势把压力转化为两次得分。 |
| 保守 / 平局路径 | 1-1 | 10% | 乌兹别克斯坦保持紧凑并惩罚一次转换。 |
| 上限 / 替代路径 | 1-0 | 9% | 低节奏比赛中，刚果（金）仍拥有更清晰的一次机会。 |

## 事实依据

- 已按 FIFA / 可信赛程来源核验比赛、场地、小组和开球；中国时间：2026-06-28 07:30。
...
| 球员 | FIFA ranking snapshot and prior group results support the baseline quality read for 刚果（金） vs 乌兹别克斯坦. | supports lean with caveats |
...
| 天气 / 场馆条件 | Venue and Climate Central Match 070 notes were checked; match-hour weather remains a late variable. | tempo risk |
...
世界杯K 组预测：刚果（金） vs 乌兹别克斯坦。倾向：刚果（金）胜，2-1。关键风险：乌兹别克斯坦反击、刚果（金）终结和末轮压力。
仅为足球赛事预测，不构成任何投资建议。

### 小红书

刚果（金） vs 乌兹别克斯坦预测：刚果（金）胜，2-1。信心：中低。临场首发和市场变化仍是主要数据缺口。
仅为足球赛事预测，不构成任何投资建议。

### 微博

K 组预测：刚果（金） vs 乌兹别克斯坦 2-1。概率：COD 41%，平局 29%，UZB 30%。
仅为足球赛事预测，不构成任何投资建议。#世界杯# #WorldCup2026#

### 微信

刚果（金） vs 乌兹别克斯坦预测：刚果（金）胜，2-1。判断基于赛程核验、FIFA 排名页、场地 / 天气资料、前序小组赛结果和截至第 066 场的复盘校准。This is a football match prediction only and does not constitute investment advice. 仅为足球赛事预测，不构成任何投资建议。
