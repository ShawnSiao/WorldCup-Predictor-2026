...
- 复核时间：2026-06-12T14:10:06+08:00。本次复核结合第 001 场和第 002 场赛后复盘：A 组前两场说明主场 / 场面优势有价值，但纪律、定位球和比赛后段控制仍是高权重变量。
- 美国目前的优势仍比巴拉圭更清楚：主场、排名、阵容可用性和前场深度都支持美国作为更可能胜者。
- 同样的复盘经验不支持把预测上调成轻松大胜。巴拉圭的低位防守、转换推进、禁区支点和定位球路线仍足以制造一球风险。
- 复核结论：保留美国 2-1，保留 56% / 24% / 20% 概率，保留中等信心。由于预测胜负和比分未变，本场配图无需刷新。
