...
source_snapshot_at: "2026-06-27T22:45:00+08:00"
lead_image_file: "../assets/cards/match-070-cod-uzb-lead.png"
image_file: "../assets/cards/match-070-cod-uzb.png"
---

# Match 070: Congo DR vs Uzbekistan

[Dashboard](../README.md) | [简体中文](match-070-cod-uzb.zh-CN.md) | [Daily report](../reports/daily/2026-06-28.md)
...
- Predicted winner: Congo DR
- Predicted scoreline: Congo DR vs Uzbekistan 2-1
...
| --- | --- | ---: | --- |
| primary | 2-1 | 11% | Congo DR's physical edge turns pressure into two scoring phases. |
| conservative_draw_path | 1-1 | 10% | Uzbekistan stay compact and punish one open transition. |
| upside_alternate | 1-0 | 9% | A lower-tempo match still leaves Congo DR with the cleaner single chance. |

## Factual Basis

- Fixture, venue, group, and kickoff were checked against FIFA/reputable schedule sources; China time: 2026-06-28 07:30.
...
| Players | FIFA ranking snapshot and prior group results support the baseline quality read for Congo DR vs Uzbekistan. | supports lean with caveats |
...
| Weather / venue conditions | Venue and Climate Central Match 070 notes were checked; match-hour weather remains a late variable. | tempo risk |
...
- Uzbekistan counters, Congo DR finishing, and final-match pressure.
...
World Cup Group K prediction: Congo DR vs Uzbekistan. Lean: Congo DR win, 2-1. Key risk: Uzbekistan counters, Congo DR finishing, and final-match pressure.
仅为足球赛事预测，不构成任何投资建议。

### Xiaohongshu / 小红书

Congo DR vs Uzbekistan prediction: Congo DR win, 2-1. Confidence: medium-low. Late lineups and market movement remain the main data gaps.
仅为足球赛事预测，不构成任何投资建议。

### Weibo / 微博

Group K prediction: Congo DR vs Uzbekistan 2-1. Probability: COD 41%, draw 29%, UZB 30%.
仅为足球赛事预测，不构成任何投资建议。#WorldCup2026#

### WeChat / 微信

Congo DR vs Uzbekistan forecast: Congo DR win, 2-1. This forecast uses fixture checks, FIFA ranking pages, venue/weather notes, prior group results, and review calibration through Match 066. This is a football match prediction only and does not constitute investment advice. 仅为足球赛事预测，不构成任何投资建议。
...
- https://www.fifa.com/en/tournaments/mens/worldcup/canadamexicousa2026/articles/matchday-17-preview-group-j-k-l
- https://www.climatecentral.org/world-cup-2026/matches/70
